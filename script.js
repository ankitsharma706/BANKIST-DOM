...
// message.innerHTML = 'We use cookies for improved experience';
...
// console.log(header.prepend(message));
...
message.style.backgroundColor = '#4352ff';
...
// 1. ad event listner to common parent element

/* 
const h1 = document.querySelector('h1');

const alerth1 = function (e) {
  alert('great your are redinh');
...
const loadImg = function (entries, observer) {
  ...
  // console.log(entry);
  if (!entry.isIntersecting) return;
  // Replace data-src with the actual image src
